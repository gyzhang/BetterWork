  ...
  return (
    ...
    >
      <mask id="bw-logo-spark">
        ...
        />
        <path
          d="M12 13.5 C10.5 12.7 8.5 12.6 6.6 13 L6.6 19 C8.5 18.6 10.5 18.7 12 19.5 Z"
          fill="#000"
        />
        <path
          d="M12 13.5 C13.5 12.7 15.5 12.6 17.4 13 L17.4 19 C15.5 18.6 13.5 18.7 12 19.5 Z"
          fill="#000"
        />
      </mask>
      <rect
