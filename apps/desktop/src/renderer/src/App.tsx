...
function KnowledgePage({ documents, results, query, setQuery, message, importing, onImport, onSearch, onOpenSource, onRemove }: { documents: KnowledgeDocumentSummary[]; results: KnowledgeSearchResult[]; query: string; setQuery: (query: string) => void; message: string; importing: boolean; onImport: () => void; onSearch: (event: FormEvent) => void; onOpenSource: (sourcePath: string) => Promise<void>; onRemove: (document: KnowledgeDocumentSummary) => Promise<void> }): React.JSX.Element {
