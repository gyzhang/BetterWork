...
当前 Phase 1 仅允许：Workspace / Task / Session 的最小持久化关系、本地 Markdown/Text/PDF 导入、源路径与哈希及页码 Locator 记录、SQLite FTS5 检索、只读 Knowledge Search Tool 及对应类型化 IPC/UI。Office 解析、Embedding、研究 Agent、Evidence 与 Artifact 仍须在后续切片单独实现。
